...
class Tela_admin:
    def __init__(self):
        ...
        self.agendamentos["columns"] = ("ID Agendamento","ID Paciente","Data Consulta","Data Agendamento","Hora Consulta","Motivo")
        ...
        for agendamento in all_agendamentos:
            self.agendamentos.insert(parent="",index="end",iid=count,text="",values=(agendamento[0],agendamento[1],agendamento[2],agendamento[3],agendamento[4],agendamento[5]))
            count += 1
